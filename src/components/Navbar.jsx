    ...
    <nav className="bg-[#014130] text-white fixed top-0 left-0 right-0 border-b border-white/10 z-50">
      ...
      {isMenuOpen && (
        <div className="md:hidden px-2 pt-2 pb-3 space-y-1">
          <Link
            to="/"
            className="block px-3 py-2 hover:bg-green-800 text-green-100"
          >
            Home
          </Link>
          <Link
          ...
          <Link
            to="/"
            className="block px-3 py-2 bg-green-900 text-green-100 rounded-md hover:bg-green-100 hover:text-green-900"
          >
            Sign Up
          </Link>
        </div>
